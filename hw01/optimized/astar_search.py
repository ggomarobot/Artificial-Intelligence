...
#                    
#                    This implementation of A* search
#                    does not allow a single city to repeat
#                    during a search path
#
################################################################
...
def astar_search(start_city, goal_city):
    ...
    print("\nSearching for path from {} to {}...\n".format(start_city, goal_city))
    ...
    while frontier:
        ...
        for city in node.children:
            ...
            if (str(child) not in reached) or (child.f_cost < reached[str(child)].f_cost):
